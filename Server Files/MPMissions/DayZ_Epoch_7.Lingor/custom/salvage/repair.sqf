    ...
    if(TradeInprogress) exitWith { cutText ["Repair already in progress." , "PLAIN DOWN", 3]; };
    ...
    if (_section and _hasToolbox) then {
            ...
            player playActionNow "Medic";
                _string2 = format["Repair selected parts - please hold on"]; //Repair - Part
            ...
            if (_finished) then {
                    ...
                    if (_damage > 0) then {
                            ...
                            //Success!
                            _successMessage = format["You have successfully attached %1 to the %2",_namePart,_nameType];
                    ...
                    cutText ["Canceled Repair.", "PLAIN DOWN", 3];
            };
     
    } else {
            _needMessage = format["You need %1 to repair this part.",_namePart];
