...
if (!isDedicated) then {
	...
	dayz_spaceInterrupt =			compile preprocessFileLineNumbers "custom\snap_build\dayz_spaceInterrupt.sqf";
  ...
  player_fillWater = compile preprocessFileLineNumbers "custom\refuel\player_waterfill.sqf";
	...
	snap_build = compile preprocessFileLineNumbers "custom\snap_build\snap_build.sqf";
	dayz_spaceInterrupt = compile preprocessFileLineNumbers "custom\snap_build\dayz_spaceInterrupt.sqf";
