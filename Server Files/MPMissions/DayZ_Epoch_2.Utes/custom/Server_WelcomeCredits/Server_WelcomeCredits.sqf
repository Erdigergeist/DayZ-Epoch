...
_role4 = "Server mod";
_role4names = ["DayZ Epoch Lingor","Wasteland","High Customized"];
_role5 = "Server Mods";
_role5names = ["Dynamische Spawns", "Trader", "Tiere", "Snapping Building", "Player Monitor Evolution","Waffen Attachments"];
_role6 = "Mehr Mods";
_role6names = ["Farbkorrektur","Wasserquellen","Direkter Lootspawn","Fahrzeuge","Bandits and Survivors","Erweitertes Bauen"];
_role7 = "Noch mehr Mods";
_role7names = ["Missionen","Selfblood","Grave Cross","Salvage vehicles","Rescue Heli","und viel mehr..."];
