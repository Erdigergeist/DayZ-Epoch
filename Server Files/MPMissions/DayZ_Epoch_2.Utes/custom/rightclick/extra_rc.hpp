...
-> remember to add your custom objects in "dayz_allowedObjects" and "DZE_maintainClasses" in your variables.sqf any object added to "DZE_isRemovable" every one have a chance to remove! */
    ...
    class PartWoodPile {
        class build21 {
            text = "Campfire (perm)";
            script = "[""Land_Campfire_burning"",[""ItemToolbox"",""ItemHatchet_DZE""],[[""PartWoodPile"", 4],[""CinderBlocks"", 1]],[0,4,0.4]] execVM ""custom\snap_build\player_build.sqf"";";
        };
    };
