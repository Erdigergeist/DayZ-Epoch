...
_repair_costs = [];
  /*
	[["Air",["ItemGoldBar",5]],["AllVehicles",["ItemGoldBar",2]]; // 5 Gold for helicopters and planes, 2 Gold for all other vehicles
  */
_repair_repairTime = 20; // time needed to repair each damaged part (in seconds)

// rearm settings
_rearm_enable = true; // enable or disable the rearm option
_rearm_costs = [];
/*
	[["ArmoredSUV_PMC_DZE",["ItemGoldBar10oz",2]],["Air",["ItemGoldBar10oz",2]],["AllVehicles",["ItemGoldBar10oz",1]]; // special costs for a single vehicle type, 2 10oz Gold for helicopters and planes, 1 10oz Gold for all other vehicles
*/
_rearm_magazineCount = 5; // amount of magazines to be added to the vehicle weapon
