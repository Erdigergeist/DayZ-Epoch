...
{			
    ...
    _handle = dayz_myCursorTarget addAction [_string, "custom\salvage\repair.sqf",[_vehicle,_part,_x], 0, false, true, "",""];
...
if(count _hitpoints > 0 ) then {
	...
	_cancel = dayz_myCursorTarget addAction ["Cancel", "custom\salvage\repair_cancel.sqf","repair", 0, true, false, "",""];
